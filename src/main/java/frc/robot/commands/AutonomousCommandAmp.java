...
public class AutonomousCommandAmp extends SequentialCommandGroup {
        ...
        addCommands(new ParallelRaceGroup(new AutonomousMove(tracaoSubsystem, 0, 0.7), new WaitCommand(0.7)));
        addCommands(new ParallelRaceGroup(new AutonomousMove(tracaoSubsystem, 0.5, 0), new WaitCommand(0.5)));
        addCommands(new ParallelRaceGroup(new AutonomousMove(tracaoSubsystem, 0, 0.7), new CollectorCommand(collectorSubsystem, Constants.CollectorConstants.collectorSpeed), new WaitCommand(2.5)));
